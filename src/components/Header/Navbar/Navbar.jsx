        ...
        <AppBar position="static" sx={{ backgroundColor: 'white'}}>
            <Container maxWidth="xl">
                <Toolbar disableGutters sx={{paddingTop: "3rem", margin: "1rem"}}>
                    <img src={PhiAllianceIco} alt="Phi Alliance" width="100px" height="100px" />

                    {/* Contenedor del menú móvil */}
                    <Box sx={{ flexGrow: 1, display: { xs: 'flex', md: 'none' }, justifyContent: "space-around", alignItems: "center", height: '100%' }}>
                        <IconButton
                            size="large"
