  ...
  return (
    ...
    >
      ...
      <Card
        ...
        fullDescripcion1={<>
          <p><strong>Aspiramos a:</strong></p>
          <p><strong>Reducir desigualdades:</strong> {aboutUs.cards[1].content[1]}</p>
          <p><strong>Acelerar la sostenibilidad: </strong>{aboutUs.cards[1].content[2]}</p>
          <p><strong>Empoderar y conectar comunidades: </strong>{aboutUs.cards[1].content[3]}</p>
        </>}
        icon={<EstrellasIcon />}
      ...
      <Card
        ...
        fullDescripcion={`${aboutUs.cards[2].content[0]} ${aboutUs.cards[2].content[1]}`}
        icon={<IAIcon />}
